	...
	<?php
		...
		class create_item {
			...
			function __construct($nome, $email, $id, $comite){
				$this->string = "<tr><td>".$nome."</td><td>".$email."</td><td><a href='alterar.php?id=$id?idcomite=$comite'>Alterar</a></td><td><a href='controle.php?id=$id?funcao=deletar_delecagao?idcomite=$comite'>Deletar</a></td></tr>";
